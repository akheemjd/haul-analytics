...
@media(max-width:700px){body{font-size:15px}.main{padding:10px 8px 30px}.grid,.grid-2{grid-template-columns:1fr;gap:10px}.card{padding:14px}.card-header h2{font-size:14px}}"""

HEAD = """<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Haul Analytics — Live US Trucking Dashboard</title>
<meta name="description" content="Free live dashboard for US trucking. Diesel prices by state, lane data, road incidents, and market intelligence. Built for fleet operators and logistics directors.">
...
<meta name="twitter:description" content="Free live dashboard for US trucking. Diesel prices by state, lane data, road incidents. Updated every 30 minutes.">
...
<div class="main">
  ...
  <div style="background:#f8f9fa;border:1px solid var(--light);padding:20px;margin-bottom:14px;text-align:center;">
    <div style="font-size:18px;font-weight:800;margin-bottom:4px;font-family:'Fira Mono',monospace;">HAUL ANALYTICS</div>
    <div style="font-size:13px;color:var(--muted);">Live US trucking dashboard — diesel prices by state, road incidents, lane data, and market intelligence.</div>
    <div style="font-size:11px;color:var(--muted);margin-top:8px;">Updated: {NOW}</div>
  </div>

  <div class="grid">
    <div class="card">
      <div class="card-header"><h2>Diesel Prices</h2><span class="pill live">Coming Soon</span></div>
      <div class="card-body"><div class="loading">US state-by-state diesel price tracking is being built. Data from EIA.</div></div>
    </div>
    <div class="card">
      <div class="card-header"><h2>Road Incidents</h2><span class="pill live">Coming Soon</span></div>
      <div class="card-body"><div class="loading">Live road incidents from US DOT and state 511 systems.</div></div>
    </div>
  </div>

  <div class="grid grid-2" style="margin-top:14px">
    <div class="card">
      <div class="card-header"><h2>Market Intelligence</h2><span class="pill daily">Coming Soon</span></div>
      <div class="card-body"><div class="loading">US economic indicators relevant to trucking. BLS, FRED, EIA data.</div></div>
    </div>
    <div class="card">
      <div class="card-header"><h2>Lane Data</h2><span class="pill daily">Coming Soon</span></div>
      <div class="card-body"><div class="loading">Rate and cost comparisons for major US freight lanes.</div></div>
    </div>
  </div>
